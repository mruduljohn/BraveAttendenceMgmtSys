...
const ManagerEmployeeForm: React.FC = () => {
      ...
      <header className="relative z-10 bg-slate-800/50 backdrop-blur-lg border-b border-blue-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-white">{isEditMode ? 'Edit' : 'Add'} Team Member</h1>
            <motion.div
          ...
          <Card className="bg-slate-800/50 backdrop-blur-lg border-blue-700">
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <motion.div variants={itemVariants}>
                <Button
                  type="submit"
                  className="w-full bg-green-500 hover:bg-green-600 text-slate-900 font-semibold py-3 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200"
                >
