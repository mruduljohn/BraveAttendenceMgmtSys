              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="bg-gray-800/50 backdrop-blur-lg border-gray-700">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium text-gray-300">Total Hours This Month</CardTitle>
                ...
                <Card className="bg-gray-800/50 backdrop-blur-lg border-gray-700">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium text-gray-300">Average Hours Per Day</CardTitle>
                ...
                <div className="w-full h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData}>
                      ...
                      />
                      <Line type="monotone" dataKey="hours" stroke="#9CA3AF" strokeWidth={2} />
                    </LineChart>
                  </ResponsiveContainer>
                </div>
              </Card>
                  ...
                  <TableBody>
                    {attendanceRecords.map((record, index) => (
                      <motion.tr key={index} variants={itemVariants}>
                        ...
                        <TableCell className="text-gray-300">{record.total_hours.toFixed(2)}</TableCell>
                        <TableCell className="text-gray-300">{record.extra_hours.toFixed(2)}</TableCell>
                        <TableCell>
                          <div className="flex items-center">
                            {record.status === "Open" ? (
